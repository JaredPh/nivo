(function (global, factory) {
  ...
  var Areas = function Areas(_ref) {
    ...
    var springs = reactSpring.useSprings(computedLines.length, computedLines.map(function (line) {
      return {
    ...
    return React__default.createElement("g", null, springs.map(function (animatedProps, index) {
