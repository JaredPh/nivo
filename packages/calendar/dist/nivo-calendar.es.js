...
var CalendarBlockLegends = memo(function (_ref) {
...
var monthPathAndBBox$1 = function monthPathAndBBox(_ref2) {
  ...
  var firstWeek;
  var lastWeek = direction === weekDirection ? timeWeek.count(date, t1) : timeWeek.count(startDate, t1);
  var firstDay = date.getDay();
  var lastDay = t1.getDay();
  var xO = originX;
  var yO = originY;
...
var getD = function getD(d, startDate, monthSpacing, daySpacing, cellSize) {
  var elapsedWeeks = timeWeek.count(startDate, d);
  var elapsedMonths = getElapsedMonths(startDate, d);
...
var computeLayout$1 = function computeLayout(_ref4) {
  ...
  dates.forEach(function (date, i) {
    days = days.concat(timeDays(date[0], date[1]).map(function (dayDate) {
      return _objectSpread2({
        date: dayDate,
    ...
    var blockMonths = timeMonths(date[0], date[1]).map(function (monthDate) {
      return _objectSpread2({
        date: monthDate,
        year: monthDate.getFullYear(),
        month: monthDate.getMonth()
...
var EnhancedCalendar = function EnhancedCalendar(_ref) {
  ...
  return React.createElement(SvgWrapper, {
    ...
    legend: monthLegend,
    theme: theme
  }), React.createElement(CalendarBlockLegends, {
    blocks: blockLegends,
    legend: blockLegend,
    theme: theme
  }), legends.map(function (legend, i) {
...
var EnhancedCalendar$1 = withContainer(EnhancedCalendar);
...
var ResponsiveEnhancedCalendar = function ResponsiveEnhancedCalendar(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(EnhancedCalendar$1, Object.assign({
      width: width,
      height: height
    }, props));
  });
...
var EnhancedCalendarCanvas = memo(function (_ref) {
  var partialMargin = _ref.margin,
      width = _ref.width,
      height = _ref.height,
      pixelRatio = _ref.pixelRatio,
  ...
  }, [canvasEl, innerHeight, innerWidth, outerWidth, outerHeight, pixelRatio, margin, days, dayBorderColor, dayBorderWidth, colorScale, blockLegend, blockLegends, monthLegend, monthLegends, legends, theme, formatLegend]);
  var handleMouseHover = useCallback(function (event) {
...
var EnhancedCalendarCanvas$1 = withContainer(EnhancedCalendarCanvas);
...
var ResponsiveEnhancedCalendarCanvas = function ResponsiveEnhancedCalendarCanvas(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(EnhancedCalendarCanvas$1, Object.assign({
      width: width,
      height: height
    }, props));
  });
...
export { Calendar$1 as Calendar, CalendarCanvas$1 as CalendarCanvas, CalendarCanvasDefaultProps, CalendarCanvasPropTypes, CalendarDefaultProps, CalendarPropTypes, EnhancedCalendar$1 as EnhancedCalendar, EnhancedCalendarCanvas$1 as EnhancedCalendarCanvas, EnhancedCalendarCanvasDefaultProps, EnhancedCalendarCanvasPropTypes, EnhancedCalendarDefaultProps, EnhancedCalendarPropTypes, ResponsiveCalendar, ResponsiveCalendarCanvas, ResponsiveEnhancedCalendar, ResponsiveEnhancedCalendarCanvas, bindDaysData, computeBlockLegendPositions, computeDomain$1 as computeDomain, computeLayout, computeMonthLegendPositions, useBlockLegends, useCalendarLayout, useColorScale, useDays, useMonthLegends };
