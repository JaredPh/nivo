(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/legends'), require('prop-types'), require('d3-time-format'), require('@nivo/tooltip'), require('lodash.memoize'), require('lodash.isdate'), require('lodash.range'), require('d3-time'), require('d3-scale')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/legends', 'prop-types', 'd3-time-format', '@nivo/tooltip', 'lodash.memoize', 'lodash.isdate', 'lodash.range', 'd3-time', 'd3-scale'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.nivo, global.PropTypes, global.d3, global.nivo, global.lodash.memoize, global.lodash.isdate, global.lodash.range, global.d3, global.d3));
}(this, (function (exports, React, core, legends, PropTypes, d3TimeFormat, tooltip, memoize, isDate, range, d3Time, d3Scale) { 'use strict';
