...
import { noop, withMotion, getColorScale, themePropType, withDimensions, withTheme, Container, SvgWrapper, ResponsiveWrapper } from '@nivo/core';
...
var BulletItem = function (_Component) {
  ...
  _createClass(BulletItem, [{
    ...
    value: function render() {
      ...
      var rangeNodes = React.createElement(EnhancedBulletRects, Object.assign({
        data: computedRanges,
        scale: scale,
        layout: layout,
        reverse: reverse,
      ...
      var markerNodes = React.createElement(BulletMarkers, Object.assign({
      ...
      if (animate !== true) {
        ...
        }, rangeNodes, React.createElement(EnhancedBulletRects, Object.assign({
    ...
    value: function render() {
      ...
      return React.createElement(Container, {
        ...
        return React.createElement(SvgWrapper, {
          ...
          return React.createElement(EnhancedBulletItem, Object.assign({
            key: d.id
          }, d, {
            layout: layout,
            reverse: reverse,
...
var ResponsiveBullet = function ResponsiveBullet(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(Bullet$1, Object.assign({
      width: width,
      height: height
    }, props));
  });
